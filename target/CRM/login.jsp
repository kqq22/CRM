                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="57%" height="25">
                                                    <div align="center">
                                                        <input type="text" name="textfield" style="width: 105px; height: 17px; background-color: #292929;
                                            ...
                                            <tr>
                                                ...
                                                <td height="25">
                                                    <div align="center">
                                                        <input type="password" name="textfield2" style="width: 105px; height: 17px; background-color: #292929;
                                                            border: solid 1px #7dbad7; font-size: 12px; color: #6cd0ff">
                                                    </div>
                                                </td>
                                                <td height="25">

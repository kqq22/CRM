    ...
    <script type="text/javascript">
        ...
        function nav(CstServiceJson) {
            ...
            $(CstServiceJson.list).each(function(index,cstservice){
                ...
                $svrDealBytd.text(cstservice.svrDealBy);
                if(cstservice.svrStatus=="已反馈"){
                    $cz.html("<a href='/findCstServiceByIdDetail?id="+cstservice.svrId+"'><img src='../images/bt_orders.gif' title='查看' style='border:0px' /></a>");
                }
                //把列添加到行
